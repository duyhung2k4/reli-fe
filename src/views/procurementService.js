...
class ProcurementService {
  async addProcurementProduct(data) {
    return await axios({
      method: "post",
      url: "http://localhost:5000/api/Procurement",
      headers: {
        accepts: "*/*",
  ...
  async getProcurementProduct(userId) {
    return await axios({
      method: "get",
      url: `http://localhost:5000/api/Procurement/${userId}`,
      headers: {
        accepts: "*/*",
        "Content-Type": "application/json",
      },
  ...
  async addProcurementProductImg(data) {
    return await axios({
      method: "post",
      url: "http://localhost:5000/api/Procurement/images",
      headers: {
        accepts: "*/*",
        "Content-Type": "application/json",
      },
  ...
  async getProcurementProductImg(productId) {
    try {
      return await axios({
        method: "get",
        url: `http://localhost:5000/api/Procurement/images/${productId}`,
